 ...
 * update the calendar yourslef. For more info, check out the SCOPES documentation at this link: http://developers.google.com/identity/protocols/oauth2/scopes
 */
...
const credentials = {
  ...
  redirect_uris: ["https://s-adil.github.io/meet/"],
  javascript_origins: ["https://s-adil.github.io", "http://localhost:3000"],
};
...
module.exports.getCalendarEvents = async (event) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    .then((results) => {
      // Response will get a list of events from the “fullstackwebdev” Google calendar using oAuth2Client for authentication
      return {
        statusCode: 200,
        headers: {
          "Access-Control-Allow-Origin": "*"
